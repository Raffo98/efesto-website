<template>
    ...
    <div class="sectionHeader">
        <button class="sectionHeader__text" @mouseover="isHover = true; dropdown()"
            @mouseleave="isHover = false; stateSection.changeSectionId('');">
        ...
        <div class="sectionHeader__arrow" v-if="props.content.subsections.length > 0">
        ...
        }" @mouseover="dropdown()" @mouseleave="stateSection.changeSectionId('');"
            v-if="props.content.subsections.length > 0">
            <button class="sectionHeader__dropdown__btn" v-for="(sub, idx) in props.content.subsections" :key="idx"
                @mouseover="
                                          {
                    isHoverSub = true;
                    idSub = sub;
        ...
        backgroundColor:
            isHoverSub && idSub == sub && idSection == props.content.title
                ...
                <p class="sectionHeader__dropdown__btn__text" v-html="sub" :style="{
                    color:
